...
with open('script3.js', 'r', encoding='utf-8') as f:
    content = f.read()
...
target_str = "translations.en.dateheader7 = WEDDING_CONFIG.date.calendarTitle.en;\n}\n\n\nfunction setLang(lang) {"

new_content = content.replace(target_str, "translations.en.dateheader7 = WEDDING_CONFIG.date.calendarTitle.en;\n}\n\n" + to_insert)
